...
- **“Горячие” данные**: последние 30 дней (~0.5 ТБ) храним в основной БД (Postgres, партиции по дню/неделе).
- Данные старше 30 дней уезжают во внешнее архивное хранилище (вторая БД с HDD / S3 / или просто партиционирвоание - теоретически можно хранить все 30 ТБ в одном инстансе и удалять их по TTL прям в базе) — обсуждается отдельно, но логика на основную БД не завязана.
